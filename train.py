...
from ner.utils.data import Data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default="data/test/char/train.char.bmes")
    parser.add_argument('--dev', default="data/test/char/dev.char.bmes")
    parser.add_argument('--test', default="data/test/char/test.char.bmes")
