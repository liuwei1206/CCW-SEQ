...
"""
the train file of word-based Chinese NER model, the input file is  golden word-based dataset
"""
...
from ner.functions.word_metric import get_gold_word_ner_measure
...
def evaluate(data, model, name):
    ...
    acc, p, r, f = get_gold_word_ner_measure(gold_results, pred_results)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default="data/test/gold-word/train.word.bmes")
    parser.add_argument('--dev', default="data/test/gold-word/dev.word.bmes")
    parser.add_argument('--test', default="data/test/gold-word/test.word.bmes")
